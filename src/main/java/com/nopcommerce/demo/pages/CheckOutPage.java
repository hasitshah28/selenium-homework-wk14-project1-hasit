...
public class CheckOutPage extends Utility {
    ...
    public void enterMandatoryDetails() {
        ...
        sendTextToElement(address, "39 Tulip street");
        ...
        sendTextToElement(phoneNumber, "45678900");
